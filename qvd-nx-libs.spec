...
%package -n qvd-libNX_X11-devel
Group:          Development/Libraries
Summary:        Development files for the Core NX protocol library
Requires:       qvd-libNX_X11-6%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_X11-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xau-devel
Group:          Development/Libraries
Summary:        Development files for the NX authorization protocol library
Requires:       qvd-libNX_Xau6%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xau-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xau6
Group:          System Environment/Libraries
Summary:        NX authorization protocol library
Requires:       %{name}%{?_isa} >= 3.5.0.29
Obsoletes:      libNX_Xau

%description -n qvd-libNX_Xau6
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xdamage1
Group:          System Environment/Libraries
Summary:        NX Damage Extension library
Requires:       %{name}%{?_isa} >= 3.5.0.29
Obsoletes:      libNX_Xdamage

%description -n qvd-libNX_Xdamage1
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xdmcp-devel
Group:          Development/Libraries
Summary:        Development files for the NXDM Control Protocol library
Requires:       %{name}%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xdmcp6%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xdmcp-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xext-devel
Group:          Development/Libraries
Summary:        Development files for the NX Common Extensions library
Requires:       qvd-libNX_Xext6%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xau6-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xext-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xfixes-devel
Group:          Development/Libraries
Summary:        Development files for the NX Xfixes extension library
Requires:       qvd-libNX_Xfixes3%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_X11-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xfixes-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xpm-devel
Group:          Development/Libraries
Summary:        Development files for the NX Pixmap image file format library
Requires:       qvd-libNX_Xpm4%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xpm-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xpm4
Group:          System Environment/Libraries
Summary:        NX Pixmap image file format library
Requires:       %{name}%{?_isa} >= 3.5.0.29
Obsoletes:      libNX_Xpm

%description -n qvd-libNX_Xpm4
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xrender-devel
Group:          Development/Libraries
Summary:        Development files for the NX Render Extension library
Requires:       qvd-libNX_Xrender1%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_X11-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libNX_Xrender-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libNX_Xrender1
Group:          System Environment/Libraries
Summary:        NX Rendering Extension library
Requires:       %{name}%{?_isa} >= 3.5.0.29
Obsoletes:      qvd-libNX_Xrender

%description -n qvd-libNX_Xrender1
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libXcomp-devel
Group:          Development/Libraries
Summary:        Development files for the NX differential compression library
Requires:       qvd-libXcomp3%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel = %{version}-%{release}

%description -n qvd-libXcomp-devel
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%package -n qvd-libXcomp3
Group:          System Environment/Libraries
Summary:        NX differential compression library
Requires:       %{name}%{?_isa} >= 3.5.0.29
Obsoletes:      libXcomp

%description -n qvd-libXcomp3
...
%package -n qvd-libXcompext-devel
Group:          Development/Libraries
Summary:        Development files for the NX compression extensions library
Requires:       qvd-libXcompext3%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_X11-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libXcompext-devel
NX is a software suite from NoMachine which implements very efficient
compression of the X11 protocol. This increases performance when
using X applications over a network, especially a slow one.
...
%package -n qvd-libXcompshad-devel
Group:          Development/Libraries
Summary:        Development files for the NX session shadowing library
Requires:       qvd-libXcompshad3%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_X11-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xext-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}
Requires:       %{name}-devel%{?_isa} = %{version}-%{release}

%description -n qvd-libXcompshad-devel
NX is a software suite from NoMachine which implements very efficient
compression of the X11 protocol. This increases performance when
using X applications over a network, especially a slow one.
...
Requires:       qvd-libNX_X11-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xau-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xdmcp-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xext-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xfixes-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xpm-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-libNX_Xrender-devel%{?_isa} = %{version}-%{release}
Requires:       qvd-nx-proto-devel%{?_isa} = %{version}-%{release}
Requires:       %{name}%{?_isa} = %{version}-%{release}

%description qvd-devel
NX is a software suite from NoMachine which implements very efficient
compression of the X11 protocol. This increases performance when
using X applications over a network, especially a slow one.
...
%package -n qvd-nx-proto-devel
Group:          Development/Libraries
Summary:        Include files for NX development

%description -n qvd-nx-proto-devel
NX is a software suite from NoMachine which implements very efficient
compression of the X11 protocol. This increases performance when
using X applications over a network, especially a slow one.
...
Summary:        NX Agent
Obsoletes:      nx < 3.5.0-19
Provides:       qvd-nx = %{version}-%{release}
Obsoletes:      nx%{?_isa} < 3.5.0-19
Provides:       qvd-nx%{?_isa} = %{version}-%{release}
%if 0%{?suse_version}
Requires:       xorg-x11-fonts-core
%endif
...
%package -n qvd-nxauth
Group:          Applications/System
Summary:        NX Auth

%description -n qvd-nxauth
NX is a software suite which implements very efficient compression of
the X11 protocol. This increases performance when using X
applications over a network, especially a slow one.
...
%post -n qvd-libNX_X11-6 -p /sbin/ldconfig
%post -n qvd-libNX_Xau6 -p /sbin/ldconfig
%post -n qvd-libNX_Xcomposite1 -p /sbin/ldconfig
%post -n qvd-libNX_Xdamage1 -p /sbin/ldconfig
%post -n qvd-libNX_Xdmcp6 -p /sbin/ldconfig
%post -n qvd-libNX_Xext6 -p /sbin/ldconfig
%post -n qvd-libNX_Xfixes3 -p /sbin/ldconfig
%post -n qvd-libNX_Xinerama1 -p /sbin/ldconfig
%post -n qvd-libNX_Xpm4 -p /sbin/ldconfig
%post -n qvd-libNX_Xrandr2 -p /sbin/ldconfig
%post -n qvd-libNX_Xrender1 -p /sbin/ldconfig
%post -n qvd-libNX_Xtst6 -p /sbin/ldconfig
%post -n qvd-libXcomp3 -p /sbin/ldconfig
%post -n qvd-libXcompext3 -p /sbin/ldconfig
%post -n qvd-libXcompshad3 -p /sbin/ldconfig
%postun -p /sbin/ldconfig
%postun -n qvd-libNX_X11-6 -p /sbin/ldconfig
%postun -n qvd-libNX_Xau6 -p /sbin/ldconfig
%postun -n qvd-libNX_Xcomposite1 -p /sbin/ldconfig
%postun -n qvd-libNX_Xdamage1 -p /sbin/ldconfig
%postun -n qvd-libNX_Xdmcp6 -p /sbin/ldconfig
%postun -n qvd-libNX_Xext6 -p /sbin/ldconfig
%postun -n qvd-libNX_Xfixes3 -p /sbin/ldconfig
%postun -n qvd-libNX_Xinerama1 -p /sbin/ldconfig
%postun -n qvd-libNX_Xpm4 -p /sbin/ldconfig
%postun -n qvd-libNX_Xrandr2 -p /sbin/ldconfig
%postun -n qvd-libNX_Xrender1 -p /sbin/ldconfig
%postun -n qvd-libNX_Xtst6 -p /sbin/ldconfig
%postun -n qvd-libXcomp3 -p /sbin/ldconfig
%postun -n qvd-libXcompext3 -p /sbin/ldconfig
%postun -n qvd-libXcompshad3 -p /sbin/ldconfig
...
%files -n qvd-libNX_X11-6
%defattr(-,root,root)
%{_libdir}/libNX_X11.so.6*

%files -n qvd-libNX_X11-devel
%defattr(-,root,root)
...
%files -n qvd-libXcompshad-devel
%defattr(-,root,root)
